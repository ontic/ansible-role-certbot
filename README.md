# Ontic Certbot ![Status](https://img.shields.io/badge/project-maintained-brightgreen.svg)

| Branch             | Build               | Galaxy              | Release              |
| :----------------- | :------------------ | :------------------ | :------------------- |
| **master**         | [![Build](https://img.shields.io/travis/ontic/ansible-role-certbot/master.svg)](https://travis-ci.org/ontic/ansible-role-certbot) | [![Galaxy](https://img.shields.io/badge/galaxy-ontic.certbot-blue.svg)](https://galaxy.ansible.com/ontic/certbot/) | [![Release](https://img.shields.io/github/release/ontic/ansible-role-certbot.svg)](https://github.com/ontic/ansible-role-certbot/releases) |

## Introduction

This role installs Certbot on RedHat/CentOS and Debian/Ubuntu Linux servers.
...
```
$ ansible-galaxy install ontic.certbot
```
...
```yml
- src: git+https://github.com/ontic/ansible-role-certbot.git
  version: master
  name: ontic.certbot
```
